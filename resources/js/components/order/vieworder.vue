...
<!-- start base div -->
    <div>
        <div class="row">
            <router-link :to="{ name: 'order'}" class="btn btn-primary">Go Back</router-link>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><b>Address :</b> {{ orders.address }}s</li>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="detail in details" :key="detail.id">
                        ...
                        <td><img :src="detail.image" class="em_photo"></td>
...
export default{
    ...
    created(){
        ...
        axios.get(globalURL+'/api/order/details/'+id)
        .then(({data}) => (this.orders = data))
        .catch(console.log('error'));

        axios.get(globalURL+'/api/order/orderdetails/'+id)
