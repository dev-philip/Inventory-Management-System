                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="user" @submit.prevent="employeeUpdate" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" id="exampleInputFirstName" placeholder="Enter Joing Date" v-model="form.joining_date">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <img :src="form.photo" style="height: 40px; width: 40px;" alt="Employee Photos">
                                    </div>
...
export default{
    ...
    methods: {
        ...
        employeeUpdate(){
            let id = this.$route.params.id;
            axios.patch(globalURL+'/api/employee/'+id, this.form)
            .then(() => {
