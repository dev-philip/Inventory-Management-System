                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="user" @submit.prevent="supplierInsert" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-danger" v-if="errors.shopename">{{ errors.shopname[0] }}</small>
                                    </div>
                                </div>
                            </div>   
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" id="exampleInputFirstNam" placeholder="Enter Your Phone Number" v-model="form.phone">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="file" class="custom-file-input" id="customFile" @change="onFileSelected" accept="image/png, image/gif, image/jpeg">
                                        <small class="text-danger" v-if="errors.photo">{{ errors.photo[0] }}</small>
                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                    </div>

                                    <div class="col-md-6">
                                        <img :src="form.photo" style="height: 40px; width: 40px;" alt="Supplier Photos">
                                    </div>
...
export default{
    ...
    methods: {
        ...
        supplierInsert(){
            axios.post(globalURL+'/api/supplier', this.form)
            .then((response) => {
