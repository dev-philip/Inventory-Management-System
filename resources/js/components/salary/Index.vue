...
<!-- start base div -->
    <div>
        <div class="row">
            <router-link :to="{ name: 'given-salary'}" class="btn btn-primary">Pay Salary</router-link>
        </div>
        <br>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Payed Salaries</h6>
                </div>
...
export default{
    ...
    methods: {
        allSalary(){
            axios.get(globalURL+'/api/salary/')
